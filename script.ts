import { Wallet, SecretNetworkClient, MsgSend, MsgMultiSend, stringToCoin } from "secretjs";
...
const secretjs3 = new SecretNetworkClient({
  url,
  chainId: "secretdev-1",
  wallet: wallet3,
...
async function run() {
    ...
    const tx = await secretjs1.tx.staking.delegate(
        ...
        //   amount: stringToCoin("3000002801235681742uscrt"),
          amount: stringToCoin("899999999998950000uscrt"),
        },
        {
          gasLimit: 50_000,
        },
